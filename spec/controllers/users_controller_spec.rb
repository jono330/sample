...
describe UsersController do
  ...
  describe "POST 'create'" do
	...
	describe "success" do
		...
		it "should have a welcome message" do
			post :create, :user => @attr
			flash[:success].should =~ /welcome to the govie market/i
		end
	...
	describe "GET 'edit'" do
		...
		it "should have a link to change the gravatar" do
			...
			response.should have_selector("a", :href => gravatar_url, :content => "Change ID Pic")
		end
	end
  end
  ...
  describe "DELETE 'destroy'" do
	...
	describe "as an admin user" do
		...
		it "should not destroy it-self" do
  ...
  describe "GET 'new'" do
	...
	it "should not let a signed-in user access the sign-up page" do
		get 'new'
		response.should redirect_to(root_path)
	end
	
	it "should not let a signed-in user create another account" do
		post :create, :user => @attr
		response.should redirect_to(root_path)
	end
  end
